<?php if (!defined('FILE_PREFIX')) include '../../../error-forbidden.php'; ?>
    <section id="page-box-apply">
        ...
        <form class="form-horizontal " id="action-form" action="http://apply.go9999.com/join/" method="post">
            <fieldset>
                <legend>基本资料</legend>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="married" id="form_married">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<select id="form_hometown_city" name="hometown_city">
							<option value="载入中">载入中</option>
						</select>
					</div>
					<!--
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="id_photo" class="input-xlarge" id="form_id_photo" type="file">
					</div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="user_photo" class="input-xlarge" id="form_user_photo" type="file">
					</div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select id="form_edu_level" name="edu_level">
							<option value=""> -- </option>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="edu_photo" class="input-xlarge" id="form_edu_photo" type="file">
					</div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="info2_edu_university" class="input-xlarge" id="edu_university" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="profession" class="input-xlarge" id="form_profession" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="input-xlarge" name="work" id="form_work">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="phone" class="input-xlarge" id="form_phone" type="text" placeholder="">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="email" class="input-xlarge" id="form_email" type="email">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    <label class="control-label" for="form_qq">QQ</label>
                    <div class="controls">
                        <input name="qq" class="input-xlarge" id="form_qq" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <select id="form_cur_city" name="cur_city" class="two_select">
                            <option value="载入中">载入中</option>
                        </select>
                    </div>
					<!--
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="cur_addr" class="input-xlarge" id="form_cur_addr" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="post_code" class="input-xlarge" id="form_post_code" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="family_title" class="input-xlarge" id="form_family_title" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="family_name" class="input-xlarge" id="form_family_name" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="family_contact" class="input-xlarge" id="form_family_contact" type="text" placeholder="">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="family_workplace" class="input-xlarge" id="form_family_workplace" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="family_addr" class="input-xlarge" id="form_family_addr" type="text">
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
						<label class="radio inline">
						  <input type="radio" name="begin_date" id="form_term_autum" value="1" checked>
						  秋季学期
						</label>
						<label class="radio inline">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="cur_income" class="input-xlarge" id="form_cur_income" rows="5"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea name="info_from" class="input-xlarge" id="form_info_from" rows="5"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div>
                        <textarea name="Q1" class="question_text input-xxlarge" id="form_Q1" rows="5" placeholder="100-500字"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div>
                        <textarea name="Q2" class="question_text input-xxlarge" id="form_Q2" rows="5" placeholder="100-500字"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div>
                        <textarea name="Q3" class="question_text input-xxlarge" id="form_Q3" rows="5" placeholder="100-500字"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="control-group">
                    ...
                    <div>
                        <textarea name="Q4" class="question_text input-xxlarge" id="form_Q4" rows="5"></textarea>
                    </div>
					<!--
					<div class="alert">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                ...
                <div class="form-actions">
                    <button class="btn btn-primary" type="button" id="submit_form">提交报名表单</button>
					<!--
